    ...
    <div className="text-center">
      ...
      {score > (passingScore ?? 0) ? (
        ...
        <DynamicDifficulty>
          ...
          the quiz a little easier or play the same difficulty by toggling the
          slider. To pass the quiz and join us as an Eironaut, you must score at
          least 7 out of 10. Have another go!
        </DynamicDifficulty>
      )}
    </div>
  );
